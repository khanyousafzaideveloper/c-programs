...
int main()
{
	cout << "static_cast <int> ( 8.9) = "   << static_cast <int> ( 8.9) << endl;
	cout << "static_cast <double> (67) =" << static_cast <float> (67) << endl;
...
<< endl;
cout << "static_cast<int>(7.8 + static_cast<double>(15 / 2)) = " << static_cast<int>(7.8 + static_cast<double>(15 / 2))
<< endl;
cout << double (9);
}
